...
const Description = () => {
  return (
    <div className={'description'}>
      Below is a lake with dimensions 10x6 fields. Frogs are marked as green rectangles. Frog with a
      small blue rectangle is a male; with a purple rectangle female.
      <br />
      <br />
      ...
      <ul>
        <li>
          Each frog can jump on an empty field (select the frog, the empty field and click the jump
          button)
        </li>
        ...
        <li>
          Two frogs different genders, adjacent can reproduce (select one frog a male, one female
